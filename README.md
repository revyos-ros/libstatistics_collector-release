...
The packages in the `libstatistics_collector` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy libstatistics_collector --override-release-repository-push-url git@github.com:revyos-ros/libstatistics_collector-release.git` on `Thu, 19 Dec 2024 11:49:47 -0000`
...
- release repository: https://github.com/revyos-ros/libstatistics_collector-release.git
...
The packages in the `libstatistics_collector` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble libstatistics_collector --override-release-repository-push-url git@github.com:revyos-ros/libstatistics_collector-release.git` on `Sat, 14 Dec 2024 08:57:27 -0000`
...
The packages in the `libstatistics_collector` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy libstatistics_collector --override-release-repository-push-url git@github.com:revyos-ros/libstatistics_collector-release.git` on `Tue, 08 Oct 2024 07:43:12 -0000`
...
## libstatistics_collector (jazzy) - 2.0.0-1

The packages in the `libstatistics_collector` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy libstatistics_collector --override-release-repository-push-url git@github.com:revyos-ros/libstatistics_collector-release.git` on `Tue, 08 Oct 2024 07:34:25 -0000`
...
## libstatistics_collector (humble) - 1.3.2-2

The packages in the `libstatistics_collector` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble libstatistics_collector --override-release-repository-push-url git@github.com:revyos-ros/libstatistics_collector-release.git` on `Thu, 26 Sep 2024 05:44:10 -0000`
...
The packages in the `libstatistics_collector` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble libstatistics_collector --override-release-repository-push-url git@github.com:revyos-ros/libstatistics_collector-release.git` on `Thu, 12 Sep 2024 04:22:51 -0000`
...
## libstatistics_collector (humble) - 1.3.1-2

The packages in the `libstatistics_collector` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble libstatistics_collector -e` on `Sun, 21 Apr 2024 14:17:19 -0000`
